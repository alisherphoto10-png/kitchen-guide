...
function buildUsbLabelTestPayload() {
  ...
  // Текст поднят выше и укрупнён (x2,y2), чтобы не обрезался по нижнему
  // краю и было видно ориентацию печати целиком.
  const lines = [
    "SIZE 58 mm,30 mm",
    "GAP 3 mm,0 mm",
    "CLS",
    'TEXT 30,60,"3",0,2,2,"KitchenDesk"',
    'TEXT 30,150,"2",0,1,1,"TEST 58x30mm"',
    "PRINT 1",
    "",
  ];
